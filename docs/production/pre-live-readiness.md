...
| Risk engine                    | `PARTIALLY_IMPLEMENTED`        | Worker avalia proposals Paper, usa decimal e reserva capital por bot atomicamente; recuperação de reservas órfãs existe, mas exposição global e E2E de concorrência ainda pendentes. |
