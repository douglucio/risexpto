...
| Risk engine                    | `PARTIALLY_IMPLEMENTED`        | Worker avalia proposals Paper, usa decimal e reserva capital por bot e global atomicamente; exposição por posições e E2E de concorrência ainda pendentes. |
