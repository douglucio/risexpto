...
| Worker runtime                 | `PARTIALLY_IMPLEMENTED`        | Worker conecta BullMQ ao Redis, consome ciclos PAPER e persiste eventos de início/fim; strategy, risk, orders, retries/reconciliation e recuperação completa ainda pendentes. |
