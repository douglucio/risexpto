...
| Worker runtime                 | `PARTIALLY_IMPLEMENTED`        | Worker conecta BullMQ ao Redis, consome ciclos PAPER e possui scheduler de reconciliação; retries, partial fills reais e recuperação completa ainda pendentes. |
