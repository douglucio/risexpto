...
| Paper trading                  | `PARTIALLY_IMPLEMENTED`        | Worker gera proposals, avalia risco e persiste Order/Trade/Position e balances PAPER; SELL, partial fill, decimal seguro e E2E da UI ainda pendentes.             |
