...
| Paper trading                  | `PARTIALLY_IMPLEMENTED`        | Worker gera proposals, avalia risco e persiste Order/Trade/Position e balances PAPER; SELL foi preparado, mas partial fill, decimal seguro e E2E da UI ainda pendentes. |
...
| Worker runtime                 | `PARTIALLY_IMPLEMENTED`        | Worker conecta BullMQ ao Redis, consome ciclos PAPER, scheduler de reconciliação e jobs de partial fill; retries, balances/positions incrementais e recuperação completa ainda pendentes. |
