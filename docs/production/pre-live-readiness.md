...
| Risk engine                    | `PARTIALLY_IMPLEMENTED`        | Worker avalia proposals Paper, usa decimal no Risk Engine e reserva capital por bot atomicamente; exposição global, reservas recuperáveis e E2E de concorrência ainda pendentes. |
