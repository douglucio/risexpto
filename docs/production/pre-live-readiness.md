...
| Worker runtime                 | `PARTIALLY_IMPLEMENTED`        | Worker agora conecta BullMQ ao Redis com shutdown gracioso; handlers de domínio, retries/reconciliation e recuperação de bots ainda pendentes.                 |
