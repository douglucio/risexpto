...
| Risk engine                    | `PARTIALLY_IMPLEMENTED`        | Worker avalia proposals Paper e persiste `RiskEvent`; Risk Engine usa `decimal.js` internamente, mas reservas transacionais e migração de todos os cálculos ainda pendentes. |
